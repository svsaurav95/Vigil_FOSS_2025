      ...
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.nav}>
          <ul>
            ...
            <li>
              <a href="/charts">
                <img style={{ marginLeft: "-2px", marginTop: "-2px", height: "30px", width: "30px" }} src={pricingICO} alt="pricing" className={styles.icon} /> Stats
              </a>
            </li>
            <li>
              <a href="/features">
      ...
      <main className={styles.mainContent}>
        ...
        <div className={styles.grid}>
          <a href="/generateticket">
            <div className={styles.card}>
              ...
              <div className={styles.cardContent}>
                ...
                <p>Generate a digital ticket for seamless entry, equipped with</p>
                <p>a secure QR code to prevent fraud and ensure easy verification.</p>
                <p>‎ </p>
          ...
          <div className={styles.card}>
            <a href="/lostfound">
              ...
              <div className={styles.cardContent}>
                ...
                <p>find missing persons, even in a group of 40-50 people.</p>
                <p>‎ </p>
                <p className={styles.rightArrow}>→</p>
              </div>
            </a>
          ...
          <div className={`${styles.card} ${styles.fullWidth}`}>
            <a href="/stampede">
              <img src={stampedefeature3} alt="Stampede Prediction" className={styles.cardImage} />
              <div className={styles.cardContent}>
          ...
          <div className={`${styles.card} ${styles.fullWidth}`}>
            <a href="/ticket">
              <img src={demographic} alt="Ticket Validation" className={styles.cardImage} />
              <div className={styles.cardContent}>
                <h2 style={{ fontSize: "2rem" }}>Demographic/Validate Ticket</h2>
                <p>Verify ticket authenticity and analyze user demographics to</p>
                <p>enhance security and streamline access control efficiently.</p>
                <p>‎ </p>
                <p className={styles.rightArrow}>→</p>
              </div>
            </a>
